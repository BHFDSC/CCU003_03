...
def save_checkpoint(df_in, database='', temp_df='ccu003_mm_temp_checkpoint', global_view_name="ccu003_mm_temp_checkpoint_gvw"):
...
def load_checkpoint(database='', temp_df=""):
...
def drop_checkpoint(database='', temp_df=""):
